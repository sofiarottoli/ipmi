...
//declaro mis variables de imagen y texto:

  imagen1 = loadImage("imagen1.jpg"); 
  imagen2 = loadImage("imagen2.jpg"); 
  imagen3 = loadImage("imagen3.jpg");
  variableDeTexto1 = "Ajedrez: un juego \nde estrategia \nmilenario";
  variableDeTexto2 = "El objetivo del ajedrez \nes dar jaque mate al \nrey del oponente";
  variableDeTexto3 = "Garry Kasparov es uno \nde los mejores jugadores \nde la historia";
...
void draw() {
  ...
  case 0:
    ...
    text(variableDeTexto1, width/6, height/2);
